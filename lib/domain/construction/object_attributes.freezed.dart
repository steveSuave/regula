...
/// User-facing label, e.g. "A" or "circumcircle". Empty = unnamed.
 ...
 double get strokeWidth;/// Point radius in logical pixels (point kinds only).
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,colorArgb,visible,labelVisible,strokeWidth,pointSize,fillAlpha);

@override
String toString() {
  return 'ObjectAttributes(name: $name, colorArgb: $colorArgb, visible: $visible, labelVisible: $labelVisible, strokeWidth: $strokeWidth, pointSize: $pointSize, fillAlpha: $fillAlpha)';
}
...
@useResult
$Res call({
 String name, int? colorArgb, bool visible, bool labelVisible, double strokeWidth, double pointSize, double? fillAlpha
});
...
/// Create a copy of ObjectAttributes
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? colorArgb = freezed,Object? visible = null,Object? labelVisible = null,Object? strokeWidth = null,Object? pointSize = null,Object? fillAlpha = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  int? colorArgb,  bool visible,  bool labelVisible,  double strokeWidth,  double pointSize,  double? fillAlpha)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ObjectAttributes() when $default != null:
return $default(_that.name,_that.colorArgb,_that.visible,_that.labelVisible,_that.strokeWidth,_that.pointSize,_that.fillAlpha);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  int? colorArgb,  bool visible,  bool labelVisible,  double strokeWidth,  double pointSize,  double? fillAlpha)  $default,) {final _that = this;
switch (_that) {
case _ObjectAttributes():
return $default(_that.name,_that.colorArgb,_that.visible,_that.labelVisible,_that.strokeWidth,_that.pointSize,_that.fillAlpha);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  int? colorArgb,  bool visible,  bool labelVisible,  double strokeWidth,  double pointSize,  double? fillAlpha)?  $default,) {final _that = this;
switch (_that) {
case _ObjectAttributes() when $default != null:
return $default(_that.name,_that.colorArgb,_that.visible,_that.labelVisible,_that.strokeWidth,_that.pointSize,_that.fillAlpha);case _:
  return null;
...
class _ObjectAttributes implements ObjectAttributes {
  const _ObjectAttributes({this.name = '', this.colorArgb, this.visible = true, this.labelVisible = true, this.strokeWidth = 2.0, this.pointSize = 4.0, this.fillAlpha});
...
/// Create a copy of ObjectAttributes
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? colorArgb = freezed,Object? visible = null,Object? labelVisible = null,Object? strokeWidth = null,Object? pointSize = null,Object? fillAlpha = freezed,}) {
